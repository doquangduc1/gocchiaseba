...
sbi_js_exists || (!function (i) {
    function e() {
        var i, e, s, t = t || {VER: "0.9.944"};
        t.bgs_Available = !1, t.bgs_CheckRunned = !1, function (i) {
            i.fn.extend({
                sbi_imgLiquid: function (e) {
                    ...
                    return this.options = e, this.settings = i.extend({}, this.defaults, this.options), this.settings.onStart && this.settings.onStart(), this.each(function (e) {
                        function a() {
                            (r.responsive || h.data("sbi_imgLiquid_oldProcessed")) && h.data("sbi_imgLiquid_settings") && (r = h.data("sbi_imgLiquid_settings"), l.actualSize = l.get(0).offsetWidth + l.get(0).offsetHeight / 1e4, l.sizeOld && l.actualSize !== l.sizeOld && o(), l.sizeOld = l.actualSize, setTimeout(a, r.responsiveCheckTime))
                        }
                        ...
                        function o() {
                            var i, s, t, a, n, o, g, u, m = 0, _ = 0, f = l.width(), c = l.height();
                            void 0 === h.data("owidth") && h.data("owidth", h[0].width), void 0 === h.data("oheight") && h.data("oheight", h[0].height), r.fill === f / c >= h.data("owidth") / h.data("oheight") ? (i = "100%", s = "auto", t = Math.floor(f), a = Math.floor(f * (h.data("oheight") / h.data("owidth")))) : (i = "auto", s = "100%", t = Math.floor(c * (h.data("owidth") / h.data("oheight"))), a = Math.floor(c)), g = f - t, "left" === (n = r.horizontalAlign.toLowerCase()) && (_ = 0), "center" === n && (_ = .5 * g), "right" === n && (_ = g), -1 !== n.indexOf("%") && ((n = parseInt(n.replace("%", ""), 10)) > 0 && (_ = g * n * .01)), u = c - a, "left" === (o = r.verticalAlign.toLowerCase()) && (m = 0), "center" === o && (m = .5 * u), "bottom" === o && (m = u), -1 !== o.indexOf("%") && ((o = parseInt(o.replace("%", ""), 10)) > 0 && (m = u * o * .01)), r.hardPixels && (i = t, s = a), h.css({
                                width: i,
                                height: s,
                        ...
                        var r = s.settings, l = i(this), h = i("img:first", l);
                        return h.length ? (h.data("sbi_imgLiquid_settings") ? (l.removeClass("sbi_imgLiquid_error").removeClass("sbi_imgLiquid_ready"), r = i.extend({}, h.data("sbi_imgLiquid_settings"), s.options)) : r = i.extend({}, s.settings, function () {
                        ...
                        }()), h.data("sbi_imgLiquid_settings", r), r.onItemStart && r.onItemStart(e, l, h), void (t.bgs_Available && r.useBackgroundSize ? (-1 === l.css("background-image").indexOf(encodeURI(h.attr("src"))) && l.css({"background-image": 'url("' + encodeURI(h.attr("src")) + '")'}), l.css({
                            ...
                            width: "100%",
                            height: "100%"
                        }), i("img", l).css({display: "none"}), r.onItemFinish && r.onItemFinish(e, l, h), l.addClass("sbi_imgLiquid_bgSize"), l.addClass("sbi_imgLiquid_ready"), d()) : function s() {
                            ...
                            return h.data("sbi_imgLiquid_oldProcessed") ? void o() : (h.data("sbi_imgLiquid_oldProcessed", !1), h.data("oldSrc", h.attr("src")), i("img:not(:first)", l).css("display", "none"), l.css({overflow: "hidden"}), h.fadeTo(0, 0).removeAttr("width").removeAttr("height").css({
                                visibility: "visible",
                                "max-width": "none",
                                "max-height": "none",
                                width: "auto",
                                height: "auto",
                                display: "block"
                            }), h.on("error", n), h[0].onerror = n, function i() {
    ...
    s.prototype = {
        createPage: function (e, s) {
            ...
            e.whenFeedsCreated(i(".sbi").each(function (e) {
                ...
                var s = i(this), n = void 0 !== s.attr("data-sbi-flags") ? s.attr("data-sbi-flags").split(",") : [],
        ...
        init: function () {
            var e = this;
            i(this.el).find("#sbi_mod_error").length && i(this.el).prepend(i(this.el).find("#sbi_mod_error")), this.settings.ajaxPostLoad ? this.getNewPostSet() : this.afterInitialImagesLoaded();
            ...
            var e = i(this.el), s = e.find(".sbi_photo").eq(0).innerWidth(), t = this.getColumnCount(),
                a = e.find("#sbi_images").innerWidth() - e.find("#sbi_images").width(), n = a / 2;
            ...
            var a = this, n = a.getImageUrls(e), o = e.find(".sbi_photo img").attr("src"), d = 150,
                r = e.find("img").get(0),
            ...
            if (!(e.hasClass("sbi_no_resraise") || e.hasClass("sbi_had_error") || e.find(".sbi_link_area").length && e.find(".sbi_link_area").hasClass("sbi_had_error"))) {
                ...
                switch (a.settings.imgRes) {
                    ...
                    case"full":
                        ...
                        break;
                    default:
                        var g = Math.max(a.settings.autoMinRes, e.find(".sbi_photo").innerWidth()),
                ...
                if (h > d || o === window.sbi.options.placeholder || t) {
                    ...
                    if (e.find(".sbi_photo img").attr("src", _), e.find(".sbi_photo").css("background-image", 'url("' + _ + '")'), d = h, "auto" === a.settings.imgRes) {
                        var f = !1;
                        e.find(".sbi_photo img").on("load", function () {
                            var s = i(this), t = s.get(0).naturalWidth / s.get(0).naturalHeight;
                            if (1e3 !== s.get(0).naturalWidth && t > l && !f) {
                                switch (a.settings.debugEnabled && console.log("rais res again for aspect ratio change " + o), f = !0, g = e.find(".sbi_photo").innerWidth(), u = a.getBestResolutionForAuto(g, t, e), h = 640, u) {
                                    case 320:
                                        h = 320;
                                        break;
                                    case 150:
                                ...
                                h > d && (_ = n[h].split("?ig_cache_key")[0], s.attr("src", _), s.closest(".sbi_photo").css("background-image", 'url("' + _ + '")')), "masonry" !== a.layout && "highlight" !== a.layout || (i(a.el).find("#sbi_images").smashotope(a.isotopeArgs), setTimeout(function () {
                ...
                e.find("img").on("error", function () {
                    if (i(this).hasClass("sbi_img_error")) console.log("unfixed error " + i(this).attr("src")); else {
                        var e;
            ...
            var s = this, t = void 0 !== e && !0 === e ? ".sbi_item.sbi_new" : ".sbi_item", a = !s.isInitialized;
            ...
            (isNaN(s) || s < 1) && (s = 1);
            var a = e * s, n = 10 * Math.ceil(a / 10), o = [150, 320, 640];
            ...
            var s = e.innerWidth(),
                ...
                a = this.getColumnCount(), n = (s - t * (a + 2)) / a;
            ...
            if ("auto" === this.settings.imgRes) this.imageResolution = "auto"; else switch (this.settings.imgRes) {
                case"thumb":
            ...
            e = jQuery, s = {
                ...
                sbiCheckVisibility: function (i, e) {
                    if (jQuery.contains(document, i[0])) {
                        var s = e.sbiPreviousVisibility, a = i.is(":visible");
            ...
            var e = i(this.el), s = this.settings.cols, t = this.settings.colsmobile, a = s;
