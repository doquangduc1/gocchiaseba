...
!function ($) {
    ...
    (Accordion = function ($element, options) {
        ...
        (void 0 === opt || void 0 === opt.scrollTo || opt.scrollTo) && (($targetElement = $((that = this).getTarget())).length && this.$element.length && setTimeout(function () {
            $targetElement.offset().top - $(window).scrollTop() - 1 * that.$element.outerHeight() < 0 && $("html, body").animate({scrollTop: $targetElement.offset().top - 1 * that.$element.outerHeight()}, 300)
        }, 300))
